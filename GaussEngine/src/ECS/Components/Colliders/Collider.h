...
namespace GAUSS
{
    ...
    protected:
        ...
        m_resolvedListeners(std::vector<CollisionFunction>()), m_collidingWith(std::vector<Entity*>()), stiffness(0) {}
    ...
    public:
        ...
        void OnCollisionResolved(const CollisionFunction& listener) {m_resolvedListeners.push_back(listener);}
    protected:
    ...
    protected:
        ...
        std::vector<CollisionFunction> m_resolvedListeners;
